      ...
      <div className="flex-1 overflow-y-auto px-4 pb-10 pt-5 flex flex-col gap-5">
        ...
        <div className="rounded-2xl p-4 flex items-center gap-3"
          ...
          <div>
            ...
            <p className="text-xs text-[#8B949E] mt-0.5">{trip.vehicleType} · {new Date(trip.tripDate).toLocaleDateString('en-IN', { day: 'numeric', month: 'short', year: 'numeric' })}</p>
          </div>
        </div>
        ...
        <div>
          ...
          <div className="flex flex-col gap-3">
            ...
            <ModeCard
              ...
              icon={<UserX size={22} color={mode === 'outside_driver' ? '#F0F6FC' : '#8B949E'} />}
